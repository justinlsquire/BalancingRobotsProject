...
%		y tick label style	= {rotate = -60, anchor = west},
		...
		[
			...
			mark			= *, % other options (may require \usetikzlibrary{plotmarks}): pentagon | pentagon* | text | cube | cube* | + | − | | | o | asterisk | star | 10-pointed star | oplus | oplus* | otimes | otimes* | square | square* | triangle | triangle* | diamond | diamond* | halfdiamond* | halfsquare* | halfsquare right* | halfsquare left* | Mercedes star | Mercedes star flipped | halfcircle | halfcircle* 
		]
		table
		[
			x=actual,
