###########################################################################
## Makefile generated for Simulink model 'BalanceCode_M2V5_Micro'. 
## 
## Makefile     : BalanceCode_M2V5_Micro.mk
## Generated on : Sat Aug 31 19:31:21 2019
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/BalanceCode_M2V5_Micro.elf
...
PRODUCT_NAME              = BalanceCode_M2V5_Micro
MAKEFILE                  = BalanceCode_M2V5_Micro.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/j/Desktop/Balance_Code_M2V5
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/BalanceCode_M2V5_Micro.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/3P778C~1.INS/ARDUIN~1.INS/ARDUIN~1.1/hardware/arduino/avr/LIBRAR~1/Wire -IC:/ProgramData/MATLAB/SupportPackages/R2018b/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/utility -ID:/Documents/MATLAB/RASPlib/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/3P778C~1.INS/ARDUIN~1.INS/ARDUIN~1.1/hardware/arduino/avr/LIBRAR~1/Wire/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/3P778C~1.INS/ARDUIN~1.INS/ARDUIN~1.1/hardware/arduino/avr/LIBRAR~1/Wire/src/utility -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/SUPPOR~1/ARDUIN~2/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/shared/svd/include -ID:/Documents/MATLAB/RASPlib/src -I$(START_DIR)/BalanceCode_M2V5_Micro_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/shared/EXTERN~1/include
...
DEFINES_STANDARD = -DMODEL=BalanceCode_M2V5_Micro -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : C:/ProgramData/MATLAB/SupportPackages/R2018b/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : C:/ProgramData/MATLAB/SupportPackages/R2018b/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : C:/ProgramData/MATLAB/SupportPackages/R2018b/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : C:/ProgramData/MATLAB/SupportPackages/R2018b/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/utility/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : C:/ProgramData/MATLAB/SupportPackages/R2018b/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/utility/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : C:/ProgramData/MATLAB/SupportPackages/R2018b/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/utility/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : C:/ProgramData/MATLAB/SupportPackages/R2018b/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/src/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : C:/ProgramData/MATLAB/SupportPackages/R2018b/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/src/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : C:/ProgramData/MATLAB/SupportPackages/R2018b/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/src/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : C:/ProgramData/MATLAB/SupportPackages/R2018b/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/src/utility/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : C:/ProgramData/MATLAB/SupportPackages/R2018b/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/src/utility/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : C:/ProgramData/MATLAB/SupportPackages/R2018b/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/src/utility/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : D:/Documents/MATLAB/RASPlib/src/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : D:/Documents/MATLAB/RASPlib/src/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : D:/Documents/MATLAB/RASPlib/src/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/BalanceCode_M2V5_Micro_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/BalanceCode_M2V5_Micro_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/BalanceCode_M2V5_Micro_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
encoder_arduino.o : D:/Documents/MATLAB/RASPlib/blocks/../src/encoder_arduino.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


PWMFSelect.o : D:/Documents/MATLAB/RASPlib/blocks/../src/PWMFSelect.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
