###########################################################################
## Makefile generated for Simulink model 'First_Test'. 
## 
## Makefile     : First_Test.mk
## Generated on : Fri Jun 14 22:08:48 2019
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/First_Test.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/Documents/GitHub/SegwayRobots/MinSeg/FirstTest
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/First_Test.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/3P778C~1.INS/ARDUIN~1.INS/ARDUIN~1.1/hardware/arduino/avr/LIBRAR~1/Wire -IC:/ProgramData/MATLAB/SupportPackages/R2018b/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/Wire/utility -ID:/Documents/MATLAB/RASPlib/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/3P778C~1.INS/ARDUIN~1.INS/ARDUIN~1.1/hardware/arduino/avr/LIBRAR~1/Wire/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/3P778C~1.INS/ARDUIN~1.INS/ARDUIN~1.1/hardware/arduino/avr/LIBRAR~1/Wire/src/utility -ID:/Documents/MATLAB/RASPlib/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/shared/svd/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/SUPPOR~1/ARDUIN~2/include -I$(START_DIR)/First_Test_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/shared/EXTERN~1/include
...
DEFINES_STANDARD = -DMODEL=First_Test -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/First_Test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/First_Test_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/First_Test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
