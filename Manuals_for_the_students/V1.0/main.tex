...
\begin{frame}
	\titlepage
	\begin{center}
		\includegraphics[height = 3.5cm]{minseg-M2V5}
	\end{center}
...
\begin{frame}{Instructions for installing the software}
	...
	\begin{center}
		\includegraphics[width = 0.9\textwidth]{arduino-board-manager}
	\end{center}
\end{frame}
...
\begin{frame}{Instructions for installing the software}
	...
	\begin{center}
		\includegraphics[width = 0.9\textwidth]{arduino-board-tool}
	\end{center}
\end{frame}
...
\begin{frame}{Instructions for installing the software}
	...
	\begin{center}
		\includegraphics[width = 0.9\textwidth]{arduino-board-manager-upload}
	\end{center}
\end{frame}
